...
# Start of ProxySG status argument passing function
def args_proxysg_status(arg1,arg2,arg3):
...
# End of ProxySG Status argument passing function

args_proxysg_status(sys.argv[1], sys.argv[2], sys.argv[3])
